...
> Related plans: [evidence-and-runtime-history.md](../history/evidence-and-runtime-history.md), [context-and-agent-history.md](../history/context-and-agent-history.md), [evidence-and-runtime-history.md](../history/evidence-and-runtime-history.md), [tool-call-text-normalization-and-final-response-governance-plan.md](./tool-call-text-normalization-and-final-response-governance-plan.md).
