...
> Superseded by [tool-governance-plan.md](../reference/tool-governance-plan.md). Keep this file for one cleanup cycle as detailed historical context; do not use it as the current tool governance source of truth.
>
