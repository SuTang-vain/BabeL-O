...
- [go-tui-tool-permission-timeout-optimization-plan.md](./go-tui-tool-permission-timeout-optimization-plan.md): Go TUI 工具调用 / 权限审批 / Timeout 优化规划；基于 `session_dcf7e34e-bc59-41e4-b802-e4d03d32b48d`，聚焦只读源码分析误走 Bash、重复 permission approval、session-scope rule 缺失与 180s timeout 的联动治理。
