...
| [task-scope-and-evidence-scope-governance-plan.md](./task-scope-and-evidence-scope-governance-plan.md) | Active Plan | Task scope, evidence scope, boundary confirmation, and out-of-scope diagnostics (`src/runtime/taskScope.ts` 404 lines). Phase 0-4 + Phase 5 Diagnostics Slice landed 2026-06-13 against `session_ef76f50a`. |
