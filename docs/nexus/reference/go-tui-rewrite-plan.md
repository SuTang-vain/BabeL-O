...
> Current baseline: `clients/go-tui/` + `bbl go` launcher (6 read-only overlays, 14 slash commands, permission panel, multi-path prebuilt install, `bbl go --check` readiness diagnostic)
