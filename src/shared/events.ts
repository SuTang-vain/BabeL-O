...
export const UserIntakeGuidanceEventSchema = z.object({
  ...
  authorizationLevel: z.enum(['none', 'inspect', 'local_change', 'shared_change', 'destructive']).optional(),
  consentScope: z.enum(['current_step', 'stated_plan', 'session_workflow']).optional(),
  consentSource: z.enum(['explicit_user', 'stated_plan_confirmation', 'trusted_session_rule', 'inferred_none']).optional(),
  selectionKind: z.enum(['none', 'preference', 'option', 'path', 'workflow_step']).optional(),
  authorizationReason: z.string().optional(),
  allowedActionSummary: z.string().optional(),
  blockedActionSummary: z.string().optional(),
  reason: z.string(),
...
export const ToolDeniedEventSchema = z.object({
  ...
  authorizationLevel: z.enum(['none', 'inspect', 'local_change', 'shared_change', 'destructive']).optional(),
  requiredAuthorizationLevel: z.enum(['none', 'inspect', 'local_change', 'shared_change', 'destructive']).optional(),
  consentScope: z.enum(['current_step', 'stated_plan', 'session_workflow']).optional(),
  authorizationReason: z.string().optional(),
  suggestedUserWording: z.string().optional(),
